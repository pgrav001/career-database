...
**Avoid:** opening with chronology ("I joined X in YYYY and...") or with a metric without a claim ("I scaled the team from 4 to 18..."). Chronology and metrics are the *proof layer*, not the *headline layer*.
