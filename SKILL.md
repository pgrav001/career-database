...
**Do:** open with the claim ("I'm the manager who takes over stalled programs and makes them ship"), then prove with chronology + metric ("most recently I inherited a platform migration that had been six months overrun; we cut over the next quarter and the program had its first on-time release in two years").
